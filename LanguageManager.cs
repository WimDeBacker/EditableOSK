...
namespace OnScreenKeyboard
{
    ...
    public static class Lang
    {
        ...
        private static readonly Dictionary<string, string> _en = new Dictionary<string, string>
        {
            ...
            // Tooltips
            ["wiz: tip Blank grid"]             = "Create an empty grid of the specified size. Fill in keys using the editor.",
            ["wiz: tip Paste labels"]           = "Type or paste key labels — one row per line, words separated by spaces.",
            ["wiz: tip Copy from file"]         = "Start from an existing layout. Theme and window settings can still be changed.",
            ...
            // Summary
            ["wiz: sum rows cols"]              = "Grid: {0} rows × {1} columns (last column reserved for ⚙ button)",
